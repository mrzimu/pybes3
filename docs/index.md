...
- <a href="convention/gid" style="text-decoration: none; color: inherit;">
    :material-identifier: __Global ID (gid)__

    Zero-based global ID (gid) for detector elements in `pybes3`.
  </a>
